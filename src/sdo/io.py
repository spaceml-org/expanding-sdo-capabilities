...
def sdo_read(year, month, day, hour, min, instr='AIA', channel='0094',
             subsample=1, basedir='/gpfs/gpfs_gl4_16mb/b9p111/fdl_sw/SDOML'):
    """
    Parameters:
    ...
    channel - 
       ...
       '0304', '0335', '1600', '1700'
       if instr=='HMI', channel should be one of 'bx', 'by', 'bz' (last is the line-of-sight
    ...
    Returns: np.array
    """
    file = '{0:s}/{1:04d}/{2:02d}/{3:02d}/{4:s}{5:04d}{6:02d}{7:02d}_{8:02d}{9:02d}_{10:s}.npz'.\
    format(basedir,year,month,day,instr,year,month,day,hour,min,channel)
    if path.isfile(file):
