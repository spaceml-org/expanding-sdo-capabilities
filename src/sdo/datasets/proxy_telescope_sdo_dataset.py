...
class ProxyTelescopeSDO_Dataset(SDO_Dataset):
    def __init__(self, num_channels, *args, **kwargs):
        super(ProxyTelescopeSDO_Dataset, self).__init__(*args, **kwargs)
        self.num_channels = num_channels

    def __getitem__(self, idx):
        data = super(ProxyTelescopeSDO_Dataset, self).__getitem__(idx)
